...
import com.example.moviecatalog.mainScreen.movieData.Genre
...
class MovieRepository {
    ...
    fun loadMovieDetails(idMovie: String): MovieDetails {    //TODO(запрос к api)
        ...
        newReview.reviewText = "Круто!"
        newReview.userId = "2131-31313123"
        newReview.nickName = "ЯЯ"
        newReview.avatar = "https://github.com/bumptech/glide/raw/master/static/glide_logo.png"
        newReview.rating = 7
        ...
        data.genres = mutableListOf(
            Genre("qweqwqw", "драма"),
            Genre("qweqwqw", "боевик"),
            Genre("qweqwqw", "фантастика"),
            Genre("qweqwqw", "мелодрамма")
        )
